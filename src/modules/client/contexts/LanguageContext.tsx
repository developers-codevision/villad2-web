...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'reservation.accountInfo': 'Información de la Cuenta',
    'reservation.zelleInstructions': 'Para completar tu reserva, realiza una transferencia Zelle a la siguiente cuenta:',
    'reservation.accountName': 'Nombre de la Cuenta:',
    'reservation.accountNumber': 'Número de Cuenta:',
    'reservation.routingNumber': 'Número de Ruta:',
    'reservation.reference': 'Referencia:',
    'reservation.amount': 'Monto:',
    'reservation.confirmationMessage': 'Una vez realizada la transferencia, envía el comprobante a nuestro WhatsApp para confirmar tu reserva.',
    'reservation.sendReceipt': 'Enviar Comprobante',
    'reservation.paymentWithBizum': 'Pago con Bizum',
    'reservation.bizumInstructions': 'Para completar tu reserva, realiza un pago Bizum al siguiente número:',
    'reservation.bizumNumber': 'Número Bizum:',
    'reservation.paymentConfirmed': 'Pago Confirmado',
    'reservation.confirmationNumber': 'Número de Confirmación:',
    'reservation.reservationDetails': 'Detalles de la Reserva',
    'reservation.guestInfo': 'Información del Huésped',
    'reservation.roomInfo': 'Información de la Habitación',
    'reservation.dates': 'Fechas',
    'reservation.guests': 'Huéspedes',
    'reservation.services': 'Servicios',
    'reservation.total': 'Total',
    'reservation.backToPayment': '← Volver a métodos de pago',
    'reservation.selectRoom': 'Seleccionar Habitación',
    'reservation.roomSelection': 'Selección de Habitación',
    ...
    'reservation.reservationSuccess': '¡Reserva exitosa!',
    'reservation.reservationSuccessDesc': 'Tu reserva ha sido confirmada. Recibirás un email con los detalles.',
    'reservation.viewReservation': 'Ver Reserva',
    'reservation.makeAnotherReservation': 'Hacer Otra Reserva',
  ...
  en: {
    ...
    'reservation.accountInfo': 'Account Information',
    'reservation.zelleInstructions': 'To complete your reservation, make a Zelle transfer to the following account:',
    'reservation.accountName': 'Account Name:',
    'reservation.accountNumber': 'Account Number:',
    'reservation.routingNumber': 'Routing Number:',
    'reservation.reference': 'Reference:',
    'reservation.amount': 'Amount:',
    'reservation.confirmationMessage': 'Once the transfer is made, send the receipt to our WhatsApp to confirm your reservation.',
    'reservation.sendReceipt': 'Send Receipt',
    'reservation.paymentWithBizum': 'Payment with Bizum',
    'reservation.bizumInstructions': 'To complete your reservation, make a Bizum payment to the following number:',
    'reservation.bizumNumber': 'Bizum Number:',
    'reservation.paymentConfirmed': 'Payment Confirmed',
    'reservation.confirmationNumber': 'Confirmation Number:',
    'reservation.reservationDetails': 'Reservation Details',
    'reservation.guestInfo': 'Guest Information',
    'reservation.roomInfo': 'Room Information',
    'reservation.dates': 'Dates',
    'reservation.guests': 'Guests',
    'reservation.services': 'Services',
    'reservation.total': 'Total',
    'reservation.backToPayment': '← Back to payment methods',
    'reservation.selectRoom': 'Select Room',
    'reservation.roomSelection': 'Room Selection',
    ...
    'reservation.servicesAndExtras': 'Services and Extras',
    'reservation.breakfast': 'Breakfast',
    'reservation.earlyCheckIn': 'Early Check-in',
    'reservation.lateCheckOut': 'Late Check-out',
    'reservation.airportTransfer': 'Airport Transfer',
    'reservation.oneWay': 'One Way',
    'reservation.roundTrip': 'Round Trip',
    'reservation.pricePerNight': 'Price per night',
    'reservation.pricePerPerson': 'Price per person',
    'reservation.pricePerService': 'Price per service',
    'reservation.subtotal': 'Subtotal',
    'reservation.taxes': 'Taxes',
    'reservation.grandTotal': 'Grand Total',
    ...
    'reservation.reservationSuccess': 'Reservation successful!',
    'reservation.reservationSuccessDesc': 'Your reservation has been confirmed. You will receive an email with the details.',
    'reservation.viewReservation': 'View Reservation',
    'reservation.makeAnotherReservation': 'Make Another Reservation',
