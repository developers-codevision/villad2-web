...
export function reservationToFormData(
  ...
  return {
    ...
    guestLastName: reservation.mainGuest.lastName || undefined,
    guestSex: reservation.mainGuest.sex,
    guestEmail: reservation.mainGuest.email || undefined,
    guestPhone: reservation.mainGuest.phone || undefined,
    guestIdNumber: undefined, // Not stored in reservation
    checkIn: inDate,
    checkOut: outDate,
...
export function formDataToCreateDto(
  ...
  return {
    ...
    mainGuest: {
      ...
      ...(formData.guestLastName && { lastName: formData.guestLastName.trim() }),
      ...(formData.guestSex && { sex: formData.guestSex }),
      ...(formData.guestEmail && { email: formData.guestEmail.trim() }),
      ...(formData.guestPhone && { phone: formData.guestPhone.trim() }),
    },
