            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {room.amenities.map((a) => (
                  <div key={a} className="flex items-center gap-2 bg-accent/50 rounded-lg px-4 py-3">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-card border border-border rounded-lg p-6 sticky top-24">
                  ...
                  <img src={room.image} alt={room.name} className="rounded-lg w-full h-40 object-cover mb-4" loading="lazy" />
                  <p className="font-semibold">{room.name}</p>
                  <p className="text-sm text-muted-foreground mb-4">{room.type} · Hasta {room.capacity} {room.capacity === 1 ? "persona" : "personas"}</p>
